...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { marca: @produto.marca, nome: @produto.nome, preco: @produto.preco, quantidade: @produto.quantidade, validade: @produto.validade } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { marca: @produto.marca, nome: @produto.nome, preco: @produto.preco, quantidade: @produto.quantidade, validade: @produto.validade } }
